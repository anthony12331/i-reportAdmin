    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(final NotificationItem notification, final OnNotificationClickListener listener) {
            ...
            if ("new_incident".equalsIgnoreCase(type)) {
                imgIcon.setImageResource(R.drawable.fire); // Placeholder
            ...
            if (notification.isRead()) {
                ...
                ((androidx.cardview.widget.CardView) itemView).setCardBackgroundColor(Color.parseColor("#1C2431"));
            } else {
                dotUnread.setVisibility(View.VISIBLE);
                ((androidx.cardview.widget.CardView) itemView).setCardBackgroundColor(Color.parseColor("#1F2A40")); // Slightly different color for unread
            }
