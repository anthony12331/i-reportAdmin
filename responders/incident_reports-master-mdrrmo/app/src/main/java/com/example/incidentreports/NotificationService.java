...
public class NotificationService extends Service {
    ...
    private void processSseData(String data) {
        try {
            ...
            } else if (REALTIME_DISCONNECT_EVENT.equalsIgnoreCase(json.optString("event"))) {
                restartRealtimeConnection();
            } else if (json.has("record")) {
                String collection = normalizeCollectionName(json.optString("collectionName"));
    ...
    private void restartRealtimeConnection() {
        executorService.execute(() -> {
