        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST, url, body,
                response -> {
                    try {
                        ...
                        String department = record.optString("department", "");
                        
                        // Restrict login to MDRRMO department only
                        if (!"MDRRMO".equalsIgnoreCase(department)) {
                            callback.onError("Access denied. This portal is for MDRRMO personnel only.");
                            return;
                        }
