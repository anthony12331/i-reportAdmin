...
import { LayoutDashboard, Users, AlertTriangle, Activity, CheckCircle2, LogOut, ShieldCheck, Radio } from 'lucide-react';
  ...
  return (
    <aside style={styles.sidebar}>
      ...
      <nav className="sidebarNavNoScroll" style={styles.nav}>
        ...
        >
          <div style={styles.navLinkGroup}>
            <Radio size={18} className={counts.pendingSos > 0 ? "animate-pulse" : ""} /> 
            <span style={counts.pendingSos > 0 ? { color: '#f87171', fontWeight: 'bold' } : {}}>Live SOS Alerts</span>
          </div>
          {counts.pendingSos > 0 && <span style={styles.badgeRed}>{counts.pendingSos}</span>}
        </div>
