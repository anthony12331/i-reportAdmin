...
export function getIncidentUrgencyScore(incident) {
  ...
  const criticalBoost = getPriorityLabel(incident) === 'Critical' ? CRITICAL_URGENCY_OFFSET : 0;
...
export function sortIncidentReportsByPriority(reports) {
  return [...reports].sort((a, b) => {
    const urgencyDifference = getIncidentUrgencyScore(b) - getIncidentUrgencyScore(a);
