              ...
              return (
                ...
                >
                  ...
                  <div style={{ borderTop: isDark ? "1px solid rgba(255, 255, 255, 0.08)" : "1px solid #f1f5f9", paddingTop: "14px", display: "flex", flexDirection: "column", flex: 1 }}>
                    <div className="ongoing-dispatch-header" style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "8px", flexWrap: "wrap", gap: "6px", flexShrink: 0 }}>
                    ...
                    >
                      {availableResponders.length === 0 ? (
                        <span style={{ fontSize: "12px", color: isDark ? "#94a3b8" : "#94a3b8", textAlign: "center", padding: "8px" }}>No standby responders</span>
                      ) : (() => {
                        ...
                        if (filtered.length === 0) {
                          return <span style={{ fontSize: "12px", color: isDark ? "#94a3b8" : "#94a3b8", textAlign: "center", padding: "8px" }}>No standby units in this department</span>;
                        }
